                  ...
                  unsigned int remain)
{
    ...
    #if 1
    keys = {40, 1, 79, 84, 56, 23, 5, 70, 81, 71, 80, 28, 97, 47, 90, 1, 80, 38, 10, 43, 94, 41, 12, 15, 6, 13, 51, 17, 7, 24, 46, 48, 77, 25, 84, 33, 48, 42, 56, 81, 13, 36, 9, 62, 36, 51, 64, 16, 90, 74, 11, 36, 67, 23, 4, 73, 88, 7, 90, 96, 31, 88, 96, 9, 65, 32, 94, 13, 74, 50, 46, 87, 39, 55, 50, 75, 7, 66, 43, 49, 40, 54, 37, 59, 30, 41, 32, 18, 48, 75, 66, 32, 63, 62, 93, 29, 47, 87, 94, 21};
    #endif 
    #if 0
    keys[0] = 15;
    keys[1] = 10;
